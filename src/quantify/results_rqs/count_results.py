...
def count_rq1(dir1, cluster1, num1):
    ...
    rq1[cluster1]["zenodo"] = (data.get("zenodo.json", {}).get("count", 0) / num1) * 100
...
if __name__ == "__main__":
    ...
    while True:
        rq = input("Input the research question (rq1, rq2, rq3, rq4, rq5) or type 'exit' to quit: ")
        ...
        if rq == "rq1":
            dir1 = input("Input the path to the outputs: ")
            cluster1 = input("Input the cluster: ")
            num1 = int(input("Number of repositories available: "))
            count_rq1(dir1, cluster1, num1)
    
        elif rq == "rq2":
            dir1 = input("Input the path to the outputs for RQ1: ") 
            dir2 = input("Input the path to the outputs for RQ2: ")
            cluster2 = input("Input the cluster: ")
            cluster1 = cluster2
            num1 = int(input("Number of repositories available: "))
            num2 = int(input("Original number of repositories available: "))
            doi,_ = count_rq1(dir1, cluster1, num1)
            count_rq2(dir2, cluster2, doi, num2)

        elif rq == "rq3":
            dir3 = input("Input the path to the outputs for classification & consistency: ")
            cluster3 = input("Input the cluster: ")
            num3 = int(input("Number of repositories available: "))
            count_rq3(dir3, cluster3, num3)

        elif rq == "rq4":
            dir4 = input("Input the path to the outputs: ")
            cluster4 = input("Input the cluster: ")
            num4 = int(input("Number of repositories available: "))
            count_rq4(dir4, cluster4,num4)

        elif rq == "rq5":
            dir5 = input("Input the path to the outputs: ")
            cluster5 = input("Input the cluster: ")
            num5 = int(input("Number of repositories available: "))
            count_rq5(dir5, cluster5, num5)
        
        else:
            print(f"Invalid input: {rq}.")
